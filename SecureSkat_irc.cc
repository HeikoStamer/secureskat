...
void init_irc(iosocketstream *irc, const std::string &nickname)
{
...
size_t irc_paramvec(std::string input, std::vector<std::string> &v)
{
    ...
    return v.size(); // return the size of the vector, i.e. number of arguments
}
...
void done_irc(iosocketstream *irc)
{
